...
'당신은 특허그룹 디딤의 IP 전문가입니다. 네이버 블로그 "IP 라운지" 카테고리의 "IP 뉴스 한 입" 경량 포맷 글을 작성합니다.
...
'다음 IP 뉴스를 "IP 뉴스 한 입" 경량 포맷으로 작성해주세요.
...
'{"min_chars":800,"max_chars":1200,"image_markers":{"min":1,"max":1},"include_title":true,"include_tags":true,"include_cta":true}'
),

-- 디딤 다이어리 (에세이/일기 포맷)
('디딤다이어리_일반', 'CAT-C', 'draft_generation',
'당신은 특허그룹 디딤의 노재일 변리사(또는 이용환 변리사)입니다. 네이버 블로그 "디딤 다이어리" 카테고리 글을 작성합니다.
...
7단계 표준 구조 사용 금지.',
'[{"name":"topic","description":"다이어리 주제","required":true},{"name":"subcategory","description":"2차 분류 (대표의 생각/컨설팅 후기/디딤 일상)","required":false},{"name":"additional_context","description":"추가 참고사항","required":false}]',
'{"min_chars":800,"max_chars":1500,"image_markers":{"min":0,"max":3},"include_title":true,"include_tags":true,"include_cta":false}'
),
