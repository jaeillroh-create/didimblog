...
⑤ 강조점: 핵심 데이터에 색상/크기/볼드 강조 지시 (구체적 색상은 글 맥락에 맞게 자유롭게)
⑥ 출처: "[출처: 법률명/기관명, 연도]" 하단 표기
⑦ 색상: 글의 톤과 감정에 맞는 배색 자유 선택 + hex 코드 명시. 단, 세련되고 전문적인 비즈니스 톤 유지
⑧ 스타일: "Clean modern flat design, white background, high resolution, 16:9"
⑨ 하단 주석: 단위, 기준일, 범례, 참고사항

이미지 퍼널 역할
- 첫 이미지 (도입부 직후): "이 글을 읽으면 이런 결과를 얻는다" — 기대감+호기심
- 중간 이미지: 해당 섹션의 핵심 데이터를 다른 관점으로 재해석 — 신뢰 강화
- 마지막 이미지 (CTA 직전): 전체 요약 또는 Before/After — 행동 촉구
