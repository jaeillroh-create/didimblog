...
다음 JSON 구조로 응답하세요 (JSON만 출력, 다른 텍스트 없이):
{
  ...
  "legal_references": ["이 글에서 언급할 법률/제도명 목록. ⚠️ 확신 있는 법률만 적으세요. 확신 없으면 적지 말고 '조세특례제한법 관련 규정' 같은 일반화 표현으로 우회하세요. '(확인 필요)' 같은 표기 절대 금지 — 본문에 그대로 흘러갑니다."],
...
## 응답 형식 (JSON)
{
  ...
  "issues": [
    {
      "category": "법률팩트 | 숫자 | 단정 | 출처 | 논리 | 광고규정",
      "severity": "심각 | 주의 | 경미",
