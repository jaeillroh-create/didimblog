...
## 응답 형식 (JSON만 출력)
{
  "infographics": [
    {
      "position": "p:3 뒤" 또는 "## 소제목 뒤",
      "type": "A~H 중 1개",
      "type_name": "비교 차트 등",
      "selection_reason": "이 유형을 선택한 이유",
      "korean_prompt": "한국어 인포그래픽 상세 설명",
      "english_prompt": "English prompt for image generation AI. ALL text in image must be Korean.",
      "emotion": "성취감/위기감/자신감/긴급함",
      "data_source": ["본문에서 추출한 데이터 요소들"]
    }
  ],
  "diversity_check": {
    "types_used": ["C", "A", "E"],
