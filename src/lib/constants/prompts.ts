...
## 분량 (엄격 준수)
공백 제외 1,500~2,000자. 1,500자 미만이면 내용을 보강하고, 2,000자 초과하면 압축하세요.
작성 완료 후 반드시 글자 수를 확인하고 범위 내에 들도록 조정하세요.

## SEO 규칙
- 핵심 키워드를 본문에 정확히 3~5회 자연스럽게 배치 (2회 이하 부족, 6회 이상 어뷰징)
- 제목 앞 15자 안에 핵심 키워드를 반드시 포함
- 문단 3~4줄 이내 (모바일 가독성)
...
## 분량 (엄격 준수)
공백 제외 800~1,200자. 이것은 경량 포맷입니다.
800자 미만이면 시사점을 보강하고, 1,200자 초과하면 반드시 압축하세요.
작성 완료 후 글자 수를 세고, 1,200자 초과 시 문장을 삭제/압축하여 범위 내에 맞추세요.

## SEO 규칙
- 핵심 키워드를 본문에 정확히 2~3회 자연스럽게 배치
- 제목에 핵심 키워드를 반드시 포함
- 문단 3~4줄 이내
...
## 분량 (엄격 준수)
공백 제외 800~1,500자. 너무 짧으면 감정과 에피소드를 보강하고, 너무 길면 간결하게 다듬으세요.
...
⚠️ 반드시 지켜야 할 핵심 규칙:
1. 공백 제외 1,500~2,000자 범위를 준수하세요
2. "{{keyword}}" 키워드를 본문에 정확히 3~5회 포함하세요 (제목 제외)
3. 제목 앞 15자 안에 "{{keyword}}" 키워드를 배치하세요
...
⚠️ 반드시 지켜야 할 핵심 규칙:
1. 공백 제외 800~1,200자 범위를 엄격히 준수하세요. 1,200자 초과 시 실패입니다.
2. "{{keyword}}" 키워드를 본문에 정확히 2~3회 포함하세요
3. 제목에 "{{keyword}}" 키워드를 포함하세요
4. 5단계 경량 구조를 따르세요 (7단계 표준 구조 사용 금지)
5. 소제목은 최대 1개, 요약 박스 사용 금지
6. CTA는 이웃 추가 유도 2줄 이내 + admin@didimip.com`,
...
⚠️ 반드시 지켜야 할 핵심 규칙:
1. 공백 제외 800~1,500자 범위를 준수하세요
2. 이것은 일기/에세이입니다. 정보 전달 글이 아닙니다
3. 자연스러운 흐름으로, 소제목 구조화 없이, 감정과 생각을 담아 작성하세요
4. CTA는 절대 넣지 마세요 (상담, 문의, 연락, 무료, 진단, 시뮬레이션, admin@ 등 일체 금지)
5. 7단계 표준 구조 사용 금지`,
};
